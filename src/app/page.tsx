  ...
  return (
    <main className="flex h-screen flex-col bg-background relative">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <div className="w-full relative flex flex-col lg:flex-row items-start justify-center pt-6 pb-10 z-10">
          ...
          <aside className="hidden lg:block w-64 ml-8 mr-4 mt-0 sticky top-0">
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-bold text-[#46474A] mb-4">Proje Özeti</h3>
          ...
          <div className="flex flex-col items-center flex-1 relative">
            ...
            <h1 className="text-xl sm:text-2xl md:text-[32px] font-bold text-[#46474A] mb-8 md:mb-12 text-center px-4 md:px-0 leading-tight md:leading-normal relative z-10">
