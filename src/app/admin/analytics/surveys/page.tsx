        ...
        <>
            ...
            <div className="flex h-screen w-full overflow-hidden bg-gray-50/50 relative font-sans">
                ...
                <div className="flex flex-1 flex-col overflow-y-auto relative">
                    <main id="survey-report-content" className="flex flex-1 flex-col gap-8 p-6 md:p-10 max-w-[1600px] mx-auto w-full pb-24 md:pb-10">
                        {/* Header */}
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-gray-500 mt-1">
                                    Anket katılımı ve geri bildirim raporları
                                </p>
                            </div>
                            <div className="flex items-center gap-3">
                                <button
                                    onClick={() => downloadDashboardAsPDF('survey-report-content', 'Anket_Analiz_Raporu')}
