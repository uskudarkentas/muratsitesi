...
export default async function MeetingAnalyticsPage() {
    const deviceStats = await getDeviceStats("TOPLANTI");
        ...
        <>
            ...
            <div className="flex h-screen w-full overflow-hidden bg-gray-50/50 relative font-sans">
                ...
                <div className="flex flex-1 flex-col overflow-y-auto relative">
                    <main id="meeting-report-content" className="flex flex-1 flex-col gap-8 p-6 md:p-10 max-w-[1600px] mx-auto w-full pb-24 md:pb-10">
                        {/* Header */}
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-gray-500 mt-1">
                                    Toplantı katılım ve karar raporları
                                </p>
                            </div>
                            <div className="flex items-center gap-3">
                                <DownloadReportButton
                                    targetId="meeting-report-content"
                                    fileName="Toplantı_Analiz_Raporu"
                                />
                            </div>
                        </div>
